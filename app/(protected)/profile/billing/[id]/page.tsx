...
export default function ViewMyBillPage() {
    const params = useParams();
    const router = useRouter();
    const billId = params.id as string;

    const { data: bill, isLoading } = trpc.bills.getMyBillById.useQuery({ id: billId });
        ...
        <div className="container mx-auto py-6 space-y-6 max-w-4xl">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Button variant="ghost" size="sm" className="p-2" onClick={() => router.push("/profile/billing")}>
            ...
            {/* Payment Details only (no internal notes) */}
            {bill.paymentDetails && (
                <Card>
