...
export const BillItemSchema = z.object({
    ...
    isScheduledChecked: z.boolean().optional().default(true),
    isActualChecked: z.boolean().optional().default(true),
});
...
export const BillSchemaCtx = z.object({
    ...
    customField3Label: z.string().optional().nullable(),
...
export const BillSchema = {
    ...
    query: z.object({
        ...
        sortBy: z.enum(["createdAt", "updatedAt", "billNo", "billDate", "status", "staff"]).default("createdAt"),
