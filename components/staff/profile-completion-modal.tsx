                                                    ...
                                                    <div className="space-y-4 p-3 border border-border/30 bg-accent/5 rounded-lg">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div>
                                                                ...
                                                                <Input id="ssn" placeholder="Only needed if sole proprietor" disabled={isPending} value={taxFields.ssn} onChange={(e) => setTaxFields(p => ({ ...p, ssn: e.target.value }))} />
                                                            </div>
                                                            <div>
                                                                <Label htmlFor="ein">EIN (XX-XXXXXXX)</Label>
                                                                <Input id="ein" placeholder="Only needed if partnership/corporation" disabled={isPending} value={taxFields.ein} onChange={(e) => setTaxFields(p => ({ ...p, ein: e.target.value }))} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
